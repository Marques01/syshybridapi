...
namespace API.Controllers
{
	...
	public class ProductController : ControllerBase
	{
		...
		[HttpPost]
		[Route("associate/category")]
		public async Task<ActionResult> AssociateProduct([FromQuery] int productId, [FromQuery] int categoryId)
		{
			await _uof.ProductRepository.AssociateProductCategory(productId, categoryId);
